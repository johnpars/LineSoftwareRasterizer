# Transform adapted from Kleber Garcia's GRR (GPU Rasterizer and Renderer)
...
class Transform:
    ...
    def __init__(self):
        self.m_rotation = Vector.q_from_angle_axis(0.0, Vector.float3(1, 0, 0))
        self.m_translation = Vector.float3(0, 0, 0)
        self.m_scale = Vector.float3(1, 1, 1)
